...
data_path = r"D:\workplaces\GRPO\data\liangfang\mid\added_workflow_to_system_2.jsonl"
    ...
    try:
        ...
        for i, msg in enumerate(messages):
            ...
            if msg["role"] == "system":
                ...
                # response = response_template.format(**json.loads(msg["slots"]), answer=msg["content"])
                tmp.append({"role": "assistant", "content": msg["content"], "slots": msg["slots"], "loss": True})
                # tmp.append({"role": "assistant", "content": response})
            else:
...
output_path = r"D:\workplaces\GRPO\data\liangfang\final\no_fnc_no_slots.jsonl"
