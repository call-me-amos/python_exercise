...
def test():
    ...
    # text = "刘忠ri∩先生，我看到您完善了信息，天津市河西区振财里小区54m?的旧房整改，您想要的风格是现代简约，全半包计划选择全包，2023-10-19装修，2023-10-10可以量房。这些信息没问题的话，我尽快帮您安排1-4家公司免费量房出方案和报价，可以吗？"
    text = "韩先生，咱们填写的信息是山西太原市万柏林区华康悦府123m?的房子要装修房屋类型：毛坯装修全半包计划：全包装修风格：现代简约可测量时间：可装修时间：辛苦补充一下信息，我给您预约当地的金牌设计师免费服务哦"
    res = get_tag(text, 1696382558)
    print("===============")
    print(f"解析小程序内容，data={res}")
